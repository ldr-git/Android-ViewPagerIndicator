 ...
 */
public class CirclePageIndicator2 extends View implements PageIndicator2 {
    ...
    public void setViewPager(ViewPager2 view) {
        ...
        mViewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                CirclePageIndicator2.this.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }

            @Override
            public void onPageSelected(int position) {
                super.onPageSelected(position);
                CirclePageIndicator2.this.onPageSelected(position);
            }

            @Override
            public void onPageScrollStateChanged(int state) {
                super.onPageScrollStateChanged(state);
                CirclePageIndicator2.this.onPageScrollStateChanged(state);
            }
        });
        invalidate();
    }
